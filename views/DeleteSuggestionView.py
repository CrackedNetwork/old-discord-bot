...
class DeleteSuggestion(Button):
    def __init__(self, bot) -> None:
        super().__init__(style=discord.ButtonStyle.danger, label="Silent Delete", emoji="🗑️")
        self.bot = bot
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if interaction.user.guild_permissions.manage_messages:
            ...
            channel = self.bot.get_channel(self.bot.settings.get("Suggestions.Deleted"))
